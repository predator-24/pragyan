const eventData = {
  ...
  posterpresentation: ["circuitrix", "unchained reaction"],
  campusxperia: ["town trace"],
  ideathon: ["code wars", "pctf", "code character"],
  funwithtech: ["aeroed"],
  escaperoom: ["friendly feud", "we are swift"],
  egaming: ["m-decoder", "sherlocked", "labyrinth"],
  workshop: ["biz quiz", "how stuff works", "elits concoction"],
};
